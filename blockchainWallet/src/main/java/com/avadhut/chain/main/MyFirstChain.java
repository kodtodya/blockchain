package com.avadhut.chain.main;
...
public class MyFirstChain {
	...
	public static HashMap<String,TransactionOutput> unspentTransactionOutputs = new HashMap<String,TransactionOutput>();
	...
	public static void main(String[] args) {	
		...
		unspentTransactionOutputs.put(genesisTransaction.outputs.get(0).id, genesisTransaction.outputs.get(0)); //its important to store our first transaction in the UTXOs list.
		...
		for(int i=1; i < blockchain.size(); i++) {
			...
			for(int t=0; t <currentBlock.transactions.size(); t++) {
				...
				for(TransactionInput input: currentTransaction.inputs) {	
					...
					if(input.unspentTransactionOut.value != tempOutput.value) {
