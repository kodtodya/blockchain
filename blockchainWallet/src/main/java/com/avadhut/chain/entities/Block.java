package com.avadhut.chain.entities;
...
public class Block {
	...
	public String calculateHash() {
		String calculatedhash = SecurityUtils
	...
	public void mineBlock(int difficulty) {
		...
		String target = SecurityUtils.getDificultyString(difficulty); // Create a string with difficulty * "0"
